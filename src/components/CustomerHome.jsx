  ...
  return (
    <div className="upstores-container">
      ...
      <header className="header">
        ...
        <div className="logo">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M12 2L15 8L22 9L17 14L18 21L12 18L6 21L7 14L2 9L9 8L12 2Z" fill="#0033FF"/>
          </svg>
          <div className="logo-text">
            <span className="brand-name">Upstores</span>
            <span className="tagline">better thinking</span>
          </div>
        </div>
